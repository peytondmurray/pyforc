...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.f_drift_kernel = QtWidgets.QSpinBox(self.groupBox_9)
        self.f_drift_kernel.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.f_drift_kernel.setMaximum(999999999)
        self.f_drift_kernel.setProperty("value", 4)
        self.f_drift_kernel.setObjectName("f_drift_kernel")
        self.gridLayout_7.addWidget(self.f_drift_kernel, 2, 3, 1, 1)
        ...
        self.f_slope_fraction_of_curve = QtWidgets.QSpinBox(self.groupBox)
        self.f_slope_fraction_of_curve.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.f_slope_fraction_of_curve.setMaximum(100)
        self.f_slope_fraction_of_curve.setProperty("value", 100)
        self.f_slope_fraction_of_curve.setObjectName("f_slope_fraction_of_curve")
        self.gridLayout.addWidget(self.f_slope_fraction_of_curve, 1, 2, 1, 1)
        ...
        self.f_linear_subtraction_slope = QtWidgets.QLineEdit(self.groupBox)
        self.f_linear_subtraction_slope.setEnabled(False)
        self.f_linear_subtraction_slope.setObjectName("f_linear_subtraction_slope")
        self.gridLayout.addWidget(self.f_linear_subtraction_slope, 2, 2, 1, 1)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(571, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_6.addItem(spacerItem4, 0, 1, 1, 1)
        spacerItem5 = QtWidgets.QSpacerItem(20, 659, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.d_log = QtWidgets.QListWidget(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.d_log.sizePolicy().hasHeightForWidth())
        self.d_log.setSizePolicy(sizePolicy)
        self.d_log.setObjectName("d_log")
        self.verticalLayout.addWidget(self.d_log)
        ...
        self.menuFile.addAction(self.a_load)
        self.menubar.addAction(self.menuFile.menuAction())
        self.label_7.setBuddy(self.f_drift_density)
        self.label_8.setBuddy(self.f_drift_kernel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Fraction of curve to fit:"))
        self.f_auto_slope.setText(_translate("MainWindow", "Auto"))
        self.f_linear_subtraction_slope.setPlaceholderText(_translate("MainWindow", "Enter slope manually..."))
